...
if ($resultc->num_rows > 0) {
    ...
    while($rowc = $resultc->fetch_assoc()) {
        ...
        $cats .='';
        $cats .='<p id="cat-'.$rowc['id'].'" style="background-color:#444; color:white; z-index:100; position:sticky; top:0px;">'.$rowc['nombre'].'</p>';
        ...
        if ($results->num_rows > 0) {
			while($rows = $results->fetch_assoc()) {
			    ...
			    $cats .= '<div class="column '.$colorsub.'is-one-third"><p style="position:sticky; top:0px;"><br><br>'.$rows['nombre'].'</p></div>  <div class="is-divider-vertical" data-content="OR"></div>';
...
$comboset='
	    <div style="display:block-inline;" class="field">
...
<div class="columns">
  <div class="column">
    ...
    <div class="field">
      <label class="label">Información sobre el link</label>
        <textarea class="textarea" rows="10" name="info" placeholder="Por qué compartes este link">'.@$info.'</textarea>
    </div>
  ...
  <div class="column">
      ...
      <label class="label is-small">Tópico</label>
  	  '.$cats.'
    </div>
    <div class="field">
